...
func (keccak *Keccak) verifyHeaderWorker(chain consensus.ChainReader, headers []*types.Header, seals []bool, index int) error {
...
func (keccak *Keccak) verifyHeader(chain consensus.ChainReader, header, parent *types.Header, uncle bool, seal bool) error {
	...
	expected := keccak.CalcDifficulty(chain, header.Time.Uint64(), parent)
...
func (keccak *Keccak) CalcDifficulty(chain consensus.ChainReader, time uint64, parent *types.Header) *big.Int {
...
func (keccak *Keccak) Prepare(chain consensus.ChainReader, header *types.Header) error {
	parent := chain.GetHeader(header.ParentHash, header.Number.Uint64()-1)
	if parent == nil {
		return consensus.ErrUnknownAncestor
	}
	header.Difficulty = keccak.CalcDifficulty(chain, header.Time.Uint64(), parent)
	return nil
}
